 ...
 * </p>
 * <ul>
 *   <li>{@link AMoDERT.Utils.impl.SetterImpl#getForAttribute <em>For Attribute</em>}</li>
 *   <li>{@link AMoDERT.Utils.impl.SetterImpl#getBase_Operation <em>Base Operation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetterImpl extends MinimalEObjectImpl.Container implements Setter {
	...
	protected EClass eStaticClass() {
		return UtilsPackage.Literals.SETTER;
	}
		...
		if (forAttribute != null && forAttribute.eIsProxy()) {
			...
			if (forAttribute != oldForAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UtilsPackage.SETTER__FOR_ATTRIBUTE, oldForAttribute, forAttribute));
			}
		}
		return forAttribute;
	}
	...
	public void setForAttribute(Property newForAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UtilsPackage.SETTER__FOR_ATTRIBUTE, oldForAttribute, forAttribute));
	}
	...
	public Operation getBase_Operation() {
		if (base_Operation != null && base_Operation.eIsProxy()) {
			...
			if (base_Operation != oldBase_Operation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UtilsPackage.SETTER__BASE_OPERATION, oldBase_Operation, base_Operation));
			}
		}
	...
	public void setBase_Operation(Operation newBase_Operation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UtilsPackage.SETTER__BASE_OPERATION, oldBase_Operation, base_Operation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UtilsPackage.SETTER__FOR_ATTRIBUTE:
				if (resolve) return getForAttribute();
				return basicGetForAttribute();
			case UtilsPackage.SETTER__BASE_OPERATION:
